...
const Inbox = () => {
  ...
  const handleSpamEmail = async (id) => {
    await markAsSpam(id);
    setEmails(emails.filter((email) => email.id !== id));
  };

  const handleStarEmail = async (id) => {
    await starEmail(id);
  };
                ...
                <div className="flex items-center space-x-4 rtl:space-x-reverse">
                    ...
                    <ul class="grid grid-cols-2 gap-1">
                      <li class="flex items-center p-3">
                        <input
                          ...
                          type="checkbox"
                          value=""
                          class="w-4 h-4 border-gray-300 rounded focus:ring-neonMintGreen dark:focus:ring-neonMintGreen dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                        />
                      </li>
                  ...
                  <div className="text-base font-semibold text-gray-900 dark:text-white">
                    <ul className="inline-flex gap-2">
                      ...
                      <li>
                        <button
                          onClick={() => handleSaveDraft(email.id)}
