  ...
  return (
    <>
      <form
        ...
        class=" bg-darkNavyBlue p-7 rounded-lg  mx-auto w-[800px]  h-[250px] mt-10 -z-50"
      >
        ...
        <div class=" mt-[5px] relative z-0 w-full mb-5 group flex border-b-2 dark:border-gray-600 ">
          <div className="w-1/4">
            <label className=" mt-[20px] peer-focus:font-medium font-bold absolute text-lg text-gray-500 dark:text-gray-400 -translate-y-6 scale-75 top-3 origin-[0]">
              Email
            </label>
          </div>
