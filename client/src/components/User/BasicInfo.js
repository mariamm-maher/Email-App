  ...
  return (
    <>
      <form
        ...
        className="bg-darkNavyBlue grid grid-rows-6 p-6 rounded-lg w-[800px] h-[400px] mt-10"
      >
        ...
        <div className="relative z-0 w-full mb-8 group border-b-2 dark:border-gray-600 flex">
          <div className="w-1/4  h-full">
            <label className="peer-focus:font-medium font-bold absolute text-lg text-gray-500 dark:text-gray-400 -translate-y-6 scale-75 top-3 origin-[0]">
              Profile picture
            </label>
          </div>
          <div className="w-2/4 h-full ">
            <label className="peer-focus:font-medium absolute text-lg text-gray-500 dark:text-gray-400 -translate-y-6 scale-75 top-3 origin-[0]">
        ...
        <div className="relative z-0 w-full mb-8 group border-b-2 dark:border-gray-600 flex">
          ...
          <div className="w-2/4 h-full ">
            <label className="peer-focus:font-medium absolute text-lg text-white font-bold -translate-y-6 scale-75 top-3 origin-[0]">
              Joe Doe
            </label>
          </div>
        </div>
